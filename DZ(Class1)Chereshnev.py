...
class App(CTk.CTk):
    def __init__(self):
        ...
        self.logo = CTk.CTkImage(dark_image=Image.open("Pass.png"), size=(460, 150))
    ...
    def set_password(self):
        ...
        self.entry_password.insert(0, passsword.create_new(length=int(self.password_length_slider.get()),
